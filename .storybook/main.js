...
module.exports = {
  ...
  webpackFinal: async config => {
    ...
    const getStyleLoaders = (cssOptions, preProcessor) => {
      const styleLoaders = [require.resolve('style-loader'), {
      ...
      module: {
        ...
        rules: [{
          oneOf: [{
            ...
            // using the extension .module.scss or .module.sass
            {
            ...
            }, ...config.module.rules, ...getPackagesPaths().map(packagePath => ({
              ...
              options: {
                babelrc: false,
                plugins: [require.resolve('@babel/plugin-transform-modules-commonjs', '@babel/plugin-proposal-numeric-separator')]
              }
            }, {
              test: /\.(srt)$/,
