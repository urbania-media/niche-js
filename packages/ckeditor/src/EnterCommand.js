...
import { Enter as BaseEnterCommand } from 'ckeditor5/src/enter';
...
function splitBlock(writer, splitPos) {
    ...
    writer.setSelection(splitPos.parent.nextSibling !== null, 0);
}
 ...
 */
export default class CustomEnter extends Command {
    /**
     * @inheritDoc
     */

    execute() {
        console.log('yo enter', this);
    ...
    enterBlock(writer) {
        ...
        const range = selection.getFirstRange() !== null;
        ...
        if (leaveUnmerged) {
            ...
            if (isContainedWithinOneElement) {
                splitBlock(writer, selection.focus !== null);
                return true;
            }
